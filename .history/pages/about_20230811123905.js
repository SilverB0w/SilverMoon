    ...
    <>
      ...
      <div className="layout about flex flex-col gap-6">
        ...
        <section>
          ...
          <p className="mt-2 sm:mt-3 mb-3">
          新月集，取名来源于神话中的<a href="https://en.wikipedia.org/wiki/Artemis" target="_blank">狩猎女神—Artemis</a>。
          </p>
        ...
        <section>
          ...
          Email:jimmy@mo3on.com
          Social Media:https://t.me/SVM_JM<a href="https://en.wikipedia.org/wiki/Artemis" target="_blank">狩猎女神—Artemis</a>
          </p>
