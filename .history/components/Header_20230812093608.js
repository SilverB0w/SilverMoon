  ...
  return (
    <>
      <div className="bg-color transition-all border-b border-neutral-200 dark:border-neutral-900 sticky h-max top-0 z-[39] ">
        <div className="relative flex "flex items-center space-x-4" items-center max-w-2xl mx-auto px-5 md:px-3 h-[60px]">
          <Link
            href="/"
            title="隽敏的个人博客"
            alt="我的小小自留地"
          ...
          >
            ...
            <h1 class="header-text text-xl m-0 ml-10">新月集</h1>


            <svg
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"
              className="w-15 h-7 fill-current"
              alt="隽敏的个人博客"
            >
